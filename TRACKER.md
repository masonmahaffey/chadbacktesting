...
| T1.6 — Create .env on server | TODO | — | Server: /opt/mbo_server/.env | — | Can run in parallel with T1.1 |
| T1.7 — Add .gitignore entries | TODO | — | arkon/.gitignore, chadbacktesting/.gitignore | — | Can run in parallel with T1.1 |
